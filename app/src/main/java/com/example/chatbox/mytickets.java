...
public class mytickets extends AppCompatActivity implements mybookingsadapter.ContactsAdapterListener {
    ...
    private void fetchContacts() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, getResources().getString(R.string.url),
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                String sql = "SELECT `ticketnumber` as `ticketnumber`, `number` as `email`, `status`, `description` FROM `transactions` where `user`='"+sharedpreferences.getString("email",null)+"' ";
...
//                    finish();
    ...
    public void onContactSelected(get_set contact) {
        ...
        Intent i=new Intent(mytickets.this,clientansactivity.class);
